...
/**
 * @inheritDoc
 * class-offsite-jcc-gateway
 */
class JCCGatewayOffsiteClass extends PaymentGateway
{
    /**
     * @inheritDoc
     */
    ...
    {
        return __('JCC Gateway - Offsite', 'jcc-give');
    }
    ...
    {
        return __('Example Gateway - Offsite', 'jcc-give');
    }
    ...
    public function getLegacyFormFieldMarkup(int $formId, array $args): string
    {
        ...
        return "<div class='jcc-offsite-help-text'>
                    <p>You will be taken away to JCC to complete the donation!</p>
                </div>";
    }
    ...
    protected function handleCreatePaymentRedirect(array $queryParams): RedirectResponse
    {
        ...
        DonationNote::create([
            ...
            'content' => 'Donation Completed from JCC Gateway Offsite.'
        ]);
